...
export function Button({
  ...
  const variantClasses = {
    primary: 'bg-primary text-background hover:bg-primary-hover focus:ring-primary',
    secondary: 'bg-surface-light text-text hover:bg-border focus:ring-border',
    danger: 'bg-error text-white hover:bg-error-hover focus:ring-error',
    ghost: 'bg-transparent text-text hover:bg-surface focus:ring-border',
  };
